...
%        - can be set to ignore directories or files
%        - sorts according to name, date modified or filesize
%        - sorts strings (e.g. names) in case-insensitive way, more useful
%          (I think) than the default matlab sorting
